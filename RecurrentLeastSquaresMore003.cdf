...
NotebookDataLength[    412406,       9159]
NotebookOptionsPosition[    391545,       8741]
NotebookOutlinePosition[    394969,       8833]
CellTagsIndexPosition[    394559,       8814]
WindowFrame->Normal*)
...
"Title",
 CellChangeTimes->{{3.727038100871808*^9, 3.727038119380846*^9}, {
  ...
  3.729197641402032*^9}},
 CellTags->"c:1",ExpressionUUID->"0540a1cc-e020-48c4-ad3a-1cf7bdc9c94f"],
...
\>", "Text",
 CellChangeTimes->{{3.727471602355763*^9, 3.7274716101393967`*^9}, {
  ...
  3.729179606176675*^9}},ExpressionUUID->"3a7a16f2-5eb2-415e-97fc-\
df9157cf69b2"],
...
Cell["Abstract", "Chapter",
 ...
 CellTags->"c:2",ExpressionUUID->"5e0180b3-3c40-44e9-aba7-410fedc57026"],
...
contemporary programming languages. "
 ...
 CellChangeTimes->{{3.7274814553838453`*^9, 3.727481471849703*^9}, {
   ...
   3.729181349663971*^9}},ExpressionUUID->"2115c394-30eb-4b9f-a4b8-\
d0c67ed6bbb2"]
}, Open  ]],
...
Cell["Motivating Example", "Chapter",
 ...
 CellTags->"c:3",ExpressionUUID->"31945649-f442-4196-bb95-0d6fdda58a65"],
...
parameters, that is, of larger order. "
 ...
 CellChangeTimes->{{3.728090971639092*^9, 3.728091137803318*^9}, {
  ...
  3.729191512351722*^9}},ExpressionUUID->"8e7d8678-0f52-4400-acfc-\
a49da6ef85f6"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727038390871489*^9, 3.727038456274043*^9}, {
  ...
  3.729162848090231*^9}},ExpressionUUID->"8b1d95a8-c2ed-47d5-bef4-\
bf781ad5dd0a"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727431219978753*^9, 3.7274313049913387`*^9}, {
  ...
  3.7289480682892017`*^9}},ExpressionUUID->"ef2f8f12-b93b-487e-9256-\
1919d3e9626d"],
...
Cell["Ground Truth", "Subchapter",
 ...
 CellTags->"c:4",ExpressionUUID->"636be563-b890-4fa7-a152-6abfb292754a"],
...
ground truth. Its purpose is to baseline or calibrate the various methods."
 ...
 CellChangeTimes->{{3.7274717486938457`*^9, 3.727471863121015*^9}, {
   ...
   3.72918106154837*^9}},ExpressionUUID->"7c797261-d812-4e3a-936b-\
9ef45fe78510"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727038221106352*^9, 3.72703825991599*^9}, {
  3.727450214764965*^9, 
  3.727450221204816*^9}},ExpressionUUID->"f02b1d24-ec6d-4eb4-9e02-\
09d18c2a6d35"]
}, Open  ]],
...
Cell["Partials", "Subchapter",
 CellChangeTimes->{{3.727038381072097*^9, 3.7270383858220654`*^9}, 
   3.727472022244463*^9},
 CellTags->"c:5",ExpressionUUID->"9f842923-9949-44ca-8d1b-b3fb047c2360"],
...
gradient 1-form of ",
 ...
 CellChangeTimes->{{3.727474059032774*^9, 3.727474241042626*^9}, {
  ...
  3.729181098851663*^9}},ExpressionUUID->"cb62cbc0-2332-4d7b-9d6b-\
e2f007285679"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727038484294626*^9, 3.727038506353806*^9}, {
   ...
   3.727472063729579*^9}},ExpressionUUID->"73c76abd-e1c6-4d15-af94-\
aa4ffbe42503"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727038583630406*^9, 3.727038608390233*^9}, 
   ...
   3.729183411371399*^9, {3.7291834466465073`*^9, 
   3.729183459697401*^9}},ExpressionUUID->"bdc06e8d-bf84-4e26-9924-\
4a30c1c21fe7"]
}, Open  ]]
}, Open  ]],
...
Cell["Faked Observations \[CapitalZeta]", "Subchapter",
 ...
 CellTags->"c:6",ExpressionUUID->"ed4b3f42-28ab-4def-aed5-10e1235e487b"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727447704011672*^9, 3.727447786446568*^9}, {
  ...
  3.727451390752479*^9, 
  3.727451399962222*^9}},ExpressionUUID->"08fa1f4e-8523-4d9d-8b61-\
64b0f864265a"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727038280219474*^9, 3.727038287790659*^9}, {
  ...
  3.7280915253683*^9, 
  3.728091537656971*^9}},ExpressionUUID->"2e33df8c-e7e6-47af-99f7-\
7e8f824a1ead"],
...
Cell[BoxData[
 TagBox[
  RowBox[{"{", 
   RowBox[{
    RowBox[{"-", "0.5739062120072711`"}], ",", 
    RowBox[{"-", "0.9799415071072372`"}], ",", 
    RowBox[{"-", "0.9623695108672259`"}], ",", "0.008817499315538435`", ",", 
    RowBox[{"\[LeftSkeleton]", "111", "\[RightSkeleton]"}], ",", 
    RowBox[{"-", "0.24636003439710152`"}], ",", "0.5071904764566877`", ",", 
    "1.2132081655800686`", ",", "1.8537291602865325`"}], "}"}],
  Short[#, 3]& ]], "Output",
 CellChangeTimes->{
  3.7270387677851763`*^9, {3.727038867149591*^9, 3.7270388773964233`*^9}, 
   ...
   3.729183459797777*^9}},ExpressionUUID->"786ddccc-5362-41ce-8b88-\
e1230bdf61d8"]
}, Open  ]]
}, Open  ]],
...
Cell["Wolfram Built-In", "Subchapter",
 ...
 CellTags->"c:7",ExpressionUUID->"359c8b98-b373-469b-934f-29e1f786de4f"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727432553517992*^9, 3.727432621798977*^9}, {
  ...
  3.729181127378771*^9}},ExpressionUUID->"22c6d9ad-db17-478b-a2c1-\
9a70a8e07a5c"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.7270391419515553`*^9, 3.727039222672346*^9}, {
   ...
   3.729022961245884*^9}},ExpressionUUID->"42c742a9-8e47-4079-8d1e-\
c231ab15c3df"],

Cell[BoxData[
 RowBox[{
  RowBox[{"-", "0.39901695134857706`"}], "+", 
  RowBox[{"0.4735135393338933`", " ", "x"}]}]], "Output",
 CellChangeTimes->{
  3.727039636453086*^9, 3.727039861741905*^9, 3.727055663158083*^9, 
   ...
   3.729183411514368*^9, {3.729183446802239*^9, 
   3.729183459872917*^9}},ExpressionUUID->"66d07b91-f398-4341-842f-\
1fe6f71b2fec"]
}, Open  ]],
...
\>", "Text",
 CellChangeTimes->{{3.727445705251766*^9, 3.727445735756525*^9}, {
   ...
   3.728091613989747*^9, 
   3.7280916153070917`*^9}},ExpressionUUID->"c0261a85-8319-47dc-9161-\
a656a0bad141"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727445423183494*^9, 3.727445453352212*^9}, {
  ...
  3.727454016578137*^9}},ExpressionUUID->"328940bc-7e47-4199-9ed4-\
4a1efae9bda5"],
...
over-fitting will not be an issue."
 ...
 CellChangeTimes->{{3.72748603072836*^9, 3.7274860648301*^9}, {
  ...
  3.7291812668515997`*^9}},ExpressionUUID->"4de7a2b1-1a1c-4854-934a-\
f1bd541fd170"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727039646243634*^9, 3.7270396697516117`*^9}, {
   ...
   3.729022988249905*^9}},ExpressionUUID->"88368414-dd8a-4931-95d3-\
d417fbd83d6f"],
...
1:
9css
       "]]}, {}}, {}, {}, {}, {}}, {{{}, {}, 
     TagBox[
...
DK9SzSahOijL1GyRQAFf733/PpeE1HWqszIZgez/Lr9fUEDCv0Lec4Y=
        "]]},
      Annotation[#, "Charting`Private`Tag$4359#1"]& ], 
     TagBox[
      {RGBColor[0.880722, 0.611041, 0.142051], AbsoluteThickness[1.6], 
       Opacity[1.], LineBox[CompressedData["
1:
dO65qjuYAlm8yMFxkUBJO8J5GWwKrq0zmllaIpDZhSFrmzAK/gPWbHfA
        "]]},
      Annotation[#, "Charting`Private`Tag$4359#2"]& ]}, {}, {}}},
  ...
  Method->{"CoordinatesToolOptions" -> {"DisplayFunction" -> ({
        ...
        (Identity[#]& )[
         Part[#, 2]]}& )}},
  PlotRange->{{-1., 3.}, {-1.8317873623416228`, 2.1399181336046302`}},
 ...
 CellChangeTimes->{{3.7270397600884542`*^9, 3.727039824579692*^9}, 
   ...
   3.729183447029324*^9, 
   3.729183459995894*^9}},ImageCache->GraphicsData["CompressedBitmap", "\<\

R3AW5xB0gXDD2Yr6OAL7Iwk3/L/GXxys\
\>"],ExpressionUUID->"ee6b0a47-57ab-4d16-bd9c-d1451791dd31"]
}, Open  ]]
}, Open  ]],
...
Cell["Normal Equations ", "Subchapter",
 ...
 CellTags->"c:8",ExpressionUUID->"b269de7a-be26-4922-acaf-81a723a49d7c"],
...
naive algebra:  ",
 ...
 CellChangeTimes->{{3.7274327843718157`*^9, 3.7274328812568607`*^9}, {
   ...
   3.729181394329205*^9}},ExpressionUUID->"027eca8b-95ac-4bf7-99fd-\
afefd3827136"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7274329995816317`*^9, 3.727433086256638*^9}, {
   ...
   3.727443813377001*^9}, 
   3.727445003473629*^9},ExpressionUUID->"e58ea470-a658-41a1-a077-\
f15140fbc9fe"],
...
\>", "Text",
 CellChangeTimes->{{3.72747218573221*^9, 3.727472199188305*^9}, {
  ...
  3.729181414139698*^9}},ExpressionUUID->"9d44798a-f562-4373-a425-\
59cf38921ada"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727039915051565*^9, 3.727039947873397*^9}, {
  ...
  3.727444668828559*^9}},ExpressionUUID->"811c82ed-ab06-4790-94d0-\
ecd8b73302d7"],

Cell[BoxData[
 RowBox[{"{", 
  RowBox[{"0.4735135393338933`", ",", 
   RowBox[{"-", "0.3990169513485769`"}]}], "}"}]], "Output",
 CellChangeTimes->{
  3.727039950530216*^9, 3.7270556632408323`*^9, 3.7270571295031*^9, 
   ...
   3.729183411801414*^9, {3.7291834470773993`*^9, 
   3.7291834600163918`*^9}},ExpressionUUID->"6b770e32-e19d-4660-b80f-\
e1c21ff9452a"]
}, Open  ]],
...
Cell["Moore-Penrose PseudoInverse", "Subsection",
 CellChangeTimes->{{3.729181426526401*^9, 
  3.729181437678577*^9}},ExpressionUUID->"7707fd38-78f2-4383-bcd0-\
20cb93b92986"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433101666657*^9, 3.727433150009388*^9}, {
  ...
  3.728091785282933*^9}},ExpressionUUID->"7ebd6adf-42c3-4957-b6a7-\
6638876f30e0"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7273712853724957`*^9, 
  3.727371293874542*^9}},ExpressionUUID->"77ff2156-b1c6-4310-a9b2-\
c57f0fb8c134"],

Cell[BoxData[
 RowBox[{"{", 
  RowBox[{"0.47351353933389306`", ",", 
   RowBox[{"-", "0.39901695134857684`"}]}], "}"}]], "Output",
 CellChangeTimes->{
  3.7273712944857807`*^9, 3.727379374585855*^9, 3.7273796194663477`*^9, 
   ...
   3.7291834118647947`*^9, {3.729183447136406*^9, 
   3.729183460090003*^9}},ExpressionUUID->"8d98d441-dea5-4812-8837-\
d41433900c5b"]
}, Open  ]]
}, Open  ]],
...
Cell["Avoiding Inversion", "Subsection",
 CellChangeTimes->{{3.7291814457025623`*^9, 
  3.729181460660458*^9}},ExpressionUUID->"f7fc67f9-4f6f-44ff-820e-\
3b72176b91b2"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.729163192693755*^9, 3.729163205069344*^9}, {
  ...
  3.7291814787717247`*^9}},ExpressionUUID->"ac89ee1f-49c2-4dc0-8890-\
ca0ca7d1c023"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7291632280602016`*^9, 
  3.72916324189844*^9}},ExpressionUUID->"f776ace7-bbb9-448f-a980-\
52f0e19caf45"],

Cell[BoxData[
 RowBox[{"{", 
  RowBox[{"0.47351353933389323`", ",", 
   RowBox[{"-", "0.39901695134857695`"}]}], "}"}]], "Output",
 CellChangeTimes->{
  3.729163242164153*^9, 3.729172307155374*^9, 3.729175690191784*^9, 
   3.729175760404626*^9, 3.729183411932454*^9, {3.729183447202159*^9, 
   3.7291834601576347`*^9}},ExpressionUUID->"7e71e9d9-6598-471a-93df-\
07e58ccc3d8f"]
}, Open  ]]
}, Open  ]],
...
Cell["Don\[CloseCurlyQuote]t Use the Normal Equations", "Subsection",
 CellChangeTimes->{{3.729023046617814*^9, 
  3.729023056448161*^9}},ExpressionUUID->"49f83c0a-5072-425c-bdb7-\
ece0f09be983"],
...
recurrence relation."
 ...
 CellChangeTimes->{{3.727472215578988*^9, 3.727472331662753*^9}, {
   ...
   3.729181589797641*^9}},ExpressionUUID->"0bcdd45b-87ce-4ddb-9793-\
9bc66cab9c99"]
}, Open  ]]
}, Open  ]]
}, Open  ]],
...
Cell["Recurrence", "Chapter",
 ...
 CellTags->"c:9",ExpressionUUID->"d1275f2e-a3da-4b1f-98da-bf8c7b69abe3"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.7274333353229113`*^9, 3.727433378179881*^9}, {
  ...
  3.728949021675457*^9, 
  3.728949025315466*^9}},ExpressionUUID->"7d69d9b6-33ee-4678-91d7-\
3657f2c7e35e"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.7274335859903107`*^9, 3.727433717944153*^9}, {
  ...
  3.728948362573649*^9}},ExpressionUUID->"82a1a969-911b-4e9d-a316-\
981c70c71134"],
...
Cell["where", "Text",
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729163279091194*^9}},ExpressionUUID->"1618b126-0186-4936-9309-\
467d5994cb4b"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.728948365542074*^9, 3.728948365542119*^9}, 3.728948905148108*^9, {
   3.728948947025461*^9, 3.728948959432898*^9}, {3.729163268464349*^9, 
   3.7291632861423903`*^9}},ExpressionUUID->"11154c61-0154-40b4-ba97-\
4360ab9a3e03"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.728948365542074*^9, 3.728948365542119*^9}, 3.728948905148108*^9, {
   3.728948947025461*^9, 3.728948959432898*^9}, {3.729163268464349*^9, 
   3.72916328446143*^9}},ExpressionUUID->"ae20b453-9228-4617-bcec-\
a5557820e42e"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.728948365542074*^9, 3.728948365542119*^9}, 3.728948905148108*^9, {
   3.728948947025461*^9, 3.728948959432898*^9}, {3.729163268464349*^9, 
   3.729163280317943*^9}},ExpressionUUID->"3e791463-5f10-43d1-b1e2-\
c60c0810d429"]
}, Open  ]],
...
Cell["Derivation Sketch", "Subsection",
 CellChangeTimes->{{3.729181602847373*^9, 
  3.7291816059298487`*^9}},ExpressionUUID->"5954b556-18d9-4032-ac64-\
ae9a8c271328"],
...
\>", "Text",
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.7291816149796658`*^9},ExpressionUUID->"646bb528-416a-4517-b32a-\
a9c22f31f8f0"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.7291639050399637`*^9}},ExpressionUUID->"dc94fce6-cb0f-48fe-bc0a-\
eb35e71e3f26"],
...
\>", "Text",
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729023129658637*^9},ExpressionUUID->"66202f25-044d-47c7-9c29-\
20ca92c13c71"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.7279665258422337`*^9}, {3.728091815451824*^9, 3.728091821154443*^9}, {
   3.729023134641241*^9, 
   3.729023151157517*^9}},ExpressionUUID->"e3cecb3e-15ed-4889-a486-\
95b386338ae8"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.728091821154443*^9}},ExpressionUUID->"79c993e7-6153-498b-ae2a-\
229fd0b73dd4"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729023197425653*^9}},ExpressionUUID->"6f110312-ef2c-4638-ade9-\
9fd0d10813c3"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729163937969397*^9}},ExpressionUUID->"1fce9ec6-c3e4-4ec7-96f3-\
c335b2ab3823"]
}, Open  ]],
...
Cell["Numerical Demonstration", "Subsection",
 CellChangeTimes->{{3.729181632544861*^9, 
  3.7291816365144157`*^9}},ExpressionUUID->"54489d09-8079-488b-a3e5-\
d19963c8f513"],
...
namely ",
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729163980174839*^9}},ExpressionUUID->"e8a29d17-3397-41ae-914e-\
47c4d0ab7f7c"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727433690566415*^9, 3.727433691990076*^9}, {
   ...
   3.729163971622809*^9}},ExpressionUUID->"77d25e25-d2e4-4931-9acf-\
802bfa6ff1ca"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727054852495049*^9, 3.72705494257406*^9}, {
   ...
   3.729174123668703*^9}},ExpressionUUID->"4f23ae9f-70c8-4a5e-802c-\
af2560f2e78a"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727472529149095*^9, 3.727472541371006*^9}, {
   ...
   3.7291834602232447`*^9}},ExpressionUUID->"446ec08f-5eda-41c0-845e-\
9d381a40b455"]
}, Open  ]],
...
built-in. For this example, the choice of ",
 ...
 CellChangeTimes->{{3.727455669635949*^9, 3.727455714844105*^9}, {
  ...
  3.729181667411229*^9}},ExpressionUUID->"f0a5ceb0-b503-47eb-ab5c-\
8f0e615184cf"]
}, Open  ]],
...
Cell["Structural Notes", "Subsection",
 CellChangeTimes->{{3.729181678137927*^9, 
  3.729181681293388*^9}},ExpressionUUID->"91dd175c-05b3-4262-bd1d-\
648e89bd6c89"],
...
dubious feature. "
 ...
 CellChangeTimes->{{3.727473114735071*^9, 3.727473196429072*^9}, 
   ...
   3.729181694426371*^9, 
   3.729181705205323*^9}},ExpressionUUID->"242b7985-2639-4612-bd86-\
a897ca4cd17e"]
}, Open  ]],
...
Cell["Memory and Time Efficiency", "Subsection",
 CellChangeTimes->{{3.729181722918578*^9, 
  3.7291817314071093`*^9}},ExpressionUUID->"c592d8cd-c418-41d2-bbea-\
22bf83deeec0"],
...
and invert matrices at much greater cost."
 ...
 CellChangeTimes->{{3.727878157797224*^9, 3.72787827045693*^9}, {
  ...
  3.729181815543811*^9}},ExpressionUUID->"07e04b00-bee5-4619-a96c-\
b3029ad6ade0"]
}, Open  ]],
...
Cell["Check the A-Priori", "Subsection",
 CellChangeTimes->{{3.729181823844157*^9, 
  3.729181830180563*^9}},ExpressionUUID->"988b02fc-5e36-4e64-9bd5-\
280c421b4fa7"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727455669635949*^9, 3.727455714844105*^9}, {
  ...
  3.729023506985579*^9}},ExpressionUUID->"28db1a8e-bdcb-4d8e-8e54-\
f46d987683c3"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7274551709419003`*^9, 3.727455208922634*^9}, {
  3.727455747486219*^9, 
  3.727455758602953*^9}},ExpressionUUID->"9de724bd-5f00-45b4-8e5d-\
9905d48bc23c"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.72745518631077*^9, 3.7274552106865807`*^9}, {
   ...
   3.729183412064961*^9, {3.72918344733591*^9, 
   3.729183460290135*^9}},ExpressionUUID->"11138716-2e1f-4dd7-8844-\
4ff6043c9bbb"]
}, Open  ]]
}, Open  ]],
...
Cell["Covariance of the Estimate", "Subsection",
 CellChangeTimes->{{3.7291818416264057`*^9, 
  3.729181847224715*^9}},ExpressionUUID->"7055f331-f3a3-453a-a494-\
b957b36d758f"],
...
Brian S. Everitt & David C. Howell, Wiley, 2005",
 ...
 CellChangeTimes->{{3.7274567852393503`*^9, 3.727456791351314*^9}, {
  ...
  3.729164348695956*^9}},ExpressionUUID->"3d3e6053-7436-412c-aaf7-\
432f3424e775"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7274431897876062`*^9, 3.7274432610082397`*^9}, {
   ...
   3.727456234387219*^9}, 
   3.727472952057025*^9},ExpressionUUID->"6577a463-4743-4190-9d2d-\
c97c9fd8b733"],

Cell[BoxData[
 TagBox[
  RowBox[{"(", "\[NoBreak]", GridBox[{
     {"0.002749505127177527`", 
      RowBox[{"-", "0.0027495051271775274`"}]},
     {
      RowBox[{"-", "0.002749505127177527`"}], "0.006477647672502988`"}
    },
    GridBoxAlignment->{
 ...
 CellChangeTimes->{{3.727454928111648*^9, 3.72745494746028*^9}, 
   ...
   3.729183447403452*^9, 
   3.729183460358261*^9}},ExpressionUUID->"4f330192-3a46-473e-a95d-\
828d595c175b"]
}, Open  ]],
...
Wolfram\[CloseCurlyQuote]s ",
 ...
 CellChangeTimes->{{3.727454999214408*^9, 3.7274550230616837`*^9}, {
  ...
  3.72812148718871*^9}},ExpressionUUID->"a628202f-e966-4d9d-a7f1-\
c3ab6af1cb55"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7274549491384163`*^9, 3.727454976961426*^9}, {
  3.727455029510784*^9, 
  3.727455047125711*^9}},ExpressionUUID->"42443ef4-b636-495c-a126-\
571f6328c76e"],

Cell[BoxData[
 TagBox[
  RowBox[{"(", "\[NoBreak]", GridBox[{
     {"0.002749505127177526`", 
      RowBox[{"-", "0.002749505127177526`"}]},
     {
      RowBox[{"-", "0.002749505127177526`"}], "0.006477647672502985`"}
    },
    GridBoxAlignment->{
     "Columns" -> {{Center}}, "ColumnsIndexed" -> {}, "Rows" -> {{Baseline}}, 
      "RowsIndexed" -> {}},
 ...
 CellChangeTimes->{{3.727454966848208*^9, 3.727454977604638*^9}, 
   ...
   3.7291834474691057`*^9, 
   3.7291834604242697`*^9}},ExpressionUUID->"5fef402e-64df-4a20-9ea1-\
7288805b0ec3"]
}, Open  ]]
}, Open  ]],
...
Cell["Don\[CloseCurlyQuote]t Invert That Matrix\.7f", "Subchapter",
 ...
 CellTags->"c:10",ExpressionUUID->"c7283fa3-6f3c-48e8-b9dd-5c884e4606fd"],
...
",
 ...
 CellChangeTimes->{{3.727377065079856*^9, 3.7273770966536922`*^9}, {
  ...
  3.729173657472382*^9, 
  3.729173717927524*^9}},ExpressionUUID->"52d0e1b9-88aa-44db-b46a-\
e9d070d60751"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727054852495049*^9, 3.72705494257406*^9}, {
   ...
   3.7291741376366043`*^9},ExpressionUUID->"b44170cf-d8cb-4d35-92bc-\
8324ead54ecb"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727473265842018*^9, 3.7274732757004232`*^9}, 
   ...
   3.7291834604902687`*^9}},ExpressionUUID->"1fa503eb-caa4-42e7-a83c-\
f3a6823f668d"]
}, Open  ]],
...
inverting them, only to get useless results."
 ...
 CellChangeTimes->{{3.727473280120357*^9, 3.7274732832085*^9}, {
   ...
   3.729181869373077*^9}},ExpressionUUID->"75251409-8106-4051-b3cd-\
26ea5360fe82"]
}, Open  ]],
...
Cell["Interim Conclusions", "Subchapter",
 CellChangeTimes->{{3.729164407912829*^9, 
  3.729164418350677*^9}},ExpressionUUID->"0f107436-ea1e-4c4c-bb27-\
5531011f4052"],
...
matrix multiplications, which are approximately ",
 ...
 CellChangeTimes->{{3.727475777156247*^9, 3.727475832537896*^9}, {
  ...
  3.729182029375617*^9}},ExpressionUUID->"3f6cfc59-a096-4c0b-a6ca-\
67dcaa9dd72b"]
}, Open  ]]
}, Closed]],
...
Cell["Sidebar: Estimating 1-Forms (Gradients)", "Chapter",
 CellChangeTimes->{{3.7273771343297157`*^9, 3.727377139800111*^9}, {
  ...
  3.729173781833387*^9}},
 CellTags->"c:11",ExpressionUUID->"d25f42d7-e348-4b08-8aea-075972d5ca64"],
...
0971576653/"],
 ...
 CellChangeTimes->{{3.729171298029805*^9, 3.729171328988427*^9}, {
  3.729171450083456*^9, 
  3.729171568542794*^9}},ExpressionUUID->"058e8af2-a7e4-44dc-a939-\
9b08a9ab82d9"],
...
\[CloseCurlyQuote]s symmetric. Adding a new observation ",
 ...
 CellChangeTimes->{{3.727371218106142*^9, 3.727371240353272*^9}, {
   ...
   3.7291820942076683`*^9}},ExpressionUUID->"ff67475b-bc6b-4a71-af3e-\
8003a280a3be"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727473769463854*^9, 3.7274737789509773`*^9}, {
  ...
  3.727519480366523*^9}},ExpressionUUID->"7d3132a4-2b2b-446f-b61b-\
d136f0749ec0"],
...
transpose of the original data:"
 ...
 CellChangeTimes->{{3.727476457185042*^9, 3.727476506319212*^9}, {
  ...
  3.727967307737608*^9}},ExpressionUUID->"86f36368-6e02-4366-ae59-\
8926407f1067"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.72747707307362*^9, 3.727477115704844*^9}, {
  ...
  3.727967373721106*^9}},ExpressionUUID->"081b1c00-655b-4d6a-af4a-\
e836f8f1d71e"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727477084780794*^9, 3.727477117039559*^9}, 
   ...
   3.729183460557459*^9}},ExpressionUUID->"d522a060-cf4b-4f3f-9ac4-\
43c6cb44f972"]
}, Open  ]],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727373282942794*^9, 3.727373311804191*^9}, {
   ...
   3.727967383277925*^9},ExpressionUUID->"3bc7a8fa-ecb0-4302-9ef5-\
1d110396a6e5"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.727383072193253*^9, 3.727383354047873*^9, 3.727383390761856*^9, 
   ...
   3.729183412498708*^9, {3.729183447769383*^9, 
   3.7291834606631536`*^9}},ExpressionUUID->"b6987308-95bf-482b-8740-\
ce77bd247ad4"]
}, Open  ]],
...
Cell["Application of the Dual Problem", "Subchapter",
 ...
 CellTags->"c:12",ExpressionUUID->"ea487781-519a-441c-b62d-c3f756100446"],
...
the co-update recurrence for this problem."
 ...
 CellChangeTimes->{{3.727371218106142*^9, 3.727371240353272*^9}, {
   ...
   3.7291821066066723`*^9}},ExpressionUUID->"5a509c16-f094-465a-9873-\
a90b9299e214"]
}, Open  ]]
}, Closed]],
...
Cell["Regularization By A-Priori in RLS and KAL", "Chapter",
 CellChangeTimes->{{3.7278786048568163`*^9, 3.727878609238576*^9}, {
  ...
  3.729182841338913*^9}},
 CellTags->"c:13",ExpressionUUID->"d3041eb5-92b7-404a-850f-04a66112104e"],
...
RLS must be renormalized with observation noise."
 ...
 CellChangeTimes->{{3.727878623850936*^9, 3.727878709219612*^9}, {
   ...
   3.7291916195642443`*^9}},ExpressionUUID->"78f968e6-c429-4867-a361-\
efe4b6cd94b3"],
...
Cell["Reproducing Bishop\[CloseCurlyQuote]s Example", "Subchapter",
 CellChangeTimes->{{3.729165065884509*^9, 
  3.7291650737726173`*^9}},ExpressionUUID->"f75aeb68-b2d1-4fe2-b440-\
ee798281f707"],
...
Cell["Bishop\[CloseCurlyQuote]s Training Set", "Subsection",
 CellChangeTimes->{{3.729182234376062*^9, 
  3.7291822398475657`*^9}},ExpressionUUID->"ee550e9c-ea98-4f79-9861-\
22b5d9bff57a"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727903592625655*^9, 3.727903632159232*^9}, {
   ...
   3.729023962286766*^9}},ExpressionUUID->"990f3c8f-a3f5-46ce-8076-\
41cac1cb9a29"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.7278793831155243`*^9, 3.727879483430056*^9}, {
  ...
  3.7279229886203623`*^9}},ExpressionUUID->"38260283-9608-49b6-af78-\
2c8c54354b43"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.7279036576643267`*^9, 3.7279153856605663`*^9, 3.727918037116987*^9, 
   ...
   3.729183412564513*^9, {3.729183447842392*^9, 
   3.729183460727846*^9}},ExpressionUUID->"d3768a8b-8ea6-4389-a199-\
b00c946c7efa"]
}, Open  ]],
...
argument, so beware. "
 ...
 CellChangeTimes->{{3.727925037995728*^9, 3.7279251079034653`*^9}, {
  ...
  3.729182224031723*^9, 
  3.7291822276320543`*^9}},ExpressionUUID->"f61cb138-a0f0-4c0a-bf98-\
bfea962e4d05"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727879752743185*^9, 3.7278799854455643`*^9}, {
  ...
  3.729175578232574*^9}},ExpressionUUID->"272dbc7d-8df8-49ec-8b2c-\
c53fcd2b8ff8"],
...
\[CloseCurlyQuote]t find in print, just my simulation."
 ...
 CellChangeTimes->{{3.7278832163983307`*^9, 3.7278832375275517`*^9}, {
  ...
  3.729182293947283*^9}},ExpressionUUID->"a39997fe-9e1c-491a-aad9-\
9408aadd0008"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.72788015184029*^9, 3.727880231778208*^9}, {
   ...
   3.7291756088584633`*^9}},ExpressionUUID->"4fd002d3-bdb5-41e8-bedd-\
6ef9e296fcdd"],
...
"Text",
 CellChangeTimes->{{3.727906073807754*^9, 3.727906077471641*^9}, {
  ...
  3.727971369779395*^9}},ExpressionUUID->"866e1d4d-888e-4229-b56c-\
dce53abe3a40"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727880085493072*^9, 3.72788013972164*^9}, {
   ...
   3.7291756286936607`*^9},ExpressionUUID->"4a9c1127-3627-47f6-8ec4-\
8560bf9df578"],
      ...
      AbsoluteThickness[1.6], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0., -0.6847967693685454}, Automatic, 
       Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.1111111111111111, 0.9925835090303646}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.2222222222222222, 0.6743981750429167}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.3333333333333333, 0.6748343160532788}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.4444444444444444, 0.6060645924388584}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.5555555555555556, -0.3148145238508862}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.6666666666666666, -0.7354152133133063}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.7777777777777777, -1.0474846808196527}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {0.8888888888888888, -0.5675129465628977}, 
       Automatic, Scaled[{0.05, 0.05}]], InsetBox[
       GraphicsBox[
        {RGBColor[0, 0, 1], AbsolutePointSize[6], AbsoluteThickness[1.6], 
         CircleBox[{0, 0}]}], {1., 0.04603508371613431}, Automatic, 
       Scaled[{0.05, 0.05}]]}, {}}, {}, {}, {}, {}}, {{{}, {}, 
     TagBox[
...
d/2HQS32uk9B6iX0YuOqqf//Lrd5d8j//98q/h8q4Y1y
  ...
  Method->{"CoordinatesToolOptions" -> {"DisplayFunction" -> ({
        ...
        (Identity[#]& )[
         Part[#, 2]]}& )}},
  PlotRange->{{0, 1.}, {-1.0474846808196527`, 0.9925835090303646}},
  PlotRangeClipping->True,
  PlotRangePadding->{{
     Scaled[0.02], 
     Scaled[0.02]}, {
 ...
 CellChangeTimes->{{3.727880775294775*^9, 3.727880787730764*^9}, {
   ...
   3.7291834608971157`*^9}},ExpressionUUID->"6b49225b-cbc8-4b7b-8df0-\
5dc90fecc4d5"]
}, Open  ]]
}, Open  ]],
...
Cell["Partials: Gradients of the Unknown Parameters", "Subsection",
 CellChangeTimes->{{3.729182306493725*^9, 
  3.7291823233798018`*^9}},ExpressionUUID->"2565f79a-7f1e-41ac-98ed-\
c307b350b9bb"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727925195515706*^9, 3.727925232785982*^9}, {
   ...
   3.7281673598690157`*^9}},ExpressionUUID->"20f33932-c0ce-496b-ba84-\
20dd169c19bf"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727887092392867*^9, 3.7278870953121367`*^9}, {
  ...
  3.727923181040741*^9}},ExpressionUUID->"c5ef3115-4000-4647-a38d-\
b0d04c406b7a"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7279231186573143`*^9, 3.7279231819525948`*^9}, 
   ...
   3.729183412718895*^9, {3.729183448005946*^9, 
   3.729183460929661*^9}},ExpressionUUID->"a1efa5e1-3f41-43f7-9ba5-\
b0da57fa445d"]
}, Open  ]]
}, Open  ]],
...
Cell["The MAP Equations", "Subsection",
 CellChangeTimes->{{3.7291823695201817`*^9, 
  3.7291823731744957`*^9}},ExpressionUUID->"5dca6b11-3eb9-4403-a5b1-\
0d09073ff6bf"],
...
the parameters to estimate as ",
 ...
 CellChangeTimes->{{3.727967934130774*^9, 3.727967994255875*^9}, {
  ...
  3.728224339280476*^9}},ExpressionUUID->"b652dd3d-eff3-44e6-9c1d-\
73d52bd6bac4"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7282207613079443`*^9, 3.728220889669578*^9}, {
  ...
  3.728251478938428*^9}},ExpressionUUID->"94dad11f-c531-478e-be8b-\
1b29ec5f91c8"],
...
functions, the number of parameters is one more than the order ",
 ...
 CellChangeTimes->{{3.728220906295454*^9, 3.728220946192494*^9}, {
   ...
   3.7291824219583178`*^9}},ExpressionUUID->"a87bfb36-4289-4a85-a77b-\
36d55500ae66"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7282219448855343`*^9, 
  3.728222027597753*^9}},ExpressionUUID->"dcb6a71c-647d-4872-a266-\
a73a8ee38945"],
...
covariant vectors, see ",
 ...
 CellChangeTimes->{{3.728222034989254*^9, 3.728222053237129*^9}, {
   ...
   3.729165352537273*^9}},ExpressionUUID->"922ff554-e6ca-4c5c-b903-\
9209bb6b8802"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.728222034989254*^9, 3.728222053237129*^9}, {
   ...
   3.7291203684585857`*^9}},ExpressionUUID->"04ed4a60-71fb-4456-a5f3-\
b071b9e464a6"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.728222034989254*^9, 3.728222053237129*^9}, {
   ...
   3.729120321664834*^9}},ExpressionUUID->"699140e6-5f32-468c-826a-\
a5fbcbd2e6dd"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.728222034989254*^9, 3.728222053237129*^9}, {
   ...
   3.7290298774959583`*^9}},ExpressionUUID->"df67d22d-39e7-4da3-9de2-\
4b4c935569aa"]
}, Open  ]],
...
as polynomial basis functions evaluated at the input points ",
 ...
 CellChangeTimes->{{3.728222034989254*^9, 3.728222053237129*^9}, {
   ...
   3.729182456005975*^9, 
   3.7291824795949993`*^9}},ExpressionUUID->"9edb37c9-2bab-4c48-98aa-\
39095519d402"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7282223267202578`*^9, 3.728222330771399*^9}, {
  ...
  3.729109798273975*^9}},ExpressionUUID->"38531c16-d3ad-4d6d-9daf-\
c22b9df38839"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.729120500205209*^9, 
  3.729120518926064*^9}},ExpressionUUID->"03488cc4-505f-4431-896e-\
e26c8e7fbfb2"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7282223267202578`*^9, 3.728222330771399*^9}, {
  ...
  3.728949826088863*^9}},ExpressionUUID->"80fe2d3b-c568-42cb-b6d9-\
0473e649be1d"]
}, Open  ]],
...
Cell["MLE: The Normal Equations", "Subsection",
 CellChangeTimes->{{3.728251929759521*^9, 
  3.728251940262474*^9}},ExpressionUUID->"3915f37e-6f20-4c96-afb0-\
ef4d3506618c"],
...
\>", "Text",
 CellChangeTimes->{{3.7279232272996387`*^9, 3.727923264174778*^9}, {
  ...
  3.7291823613313932`*^9}},ExpressionUUID->"1331db85-25bb-459f-b990-\
54e347a1a614"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727885728192296*^9, 3.727885779639097*^9}, {
   ...
   3.7291764366839447`*^9}},ExpressionUUID->"2e3a89e1-95e7-47a0-aa93-\
38f8fd6551a0"],

Cell[BoxData[
 RowBox[{"{", 
  RowBox[{
   RowBox[{"-", "0.5254341504829295`"}], ",", "13.620014202731662`", ",", 
   RowBox[{"-", "36.696352757454484`"}], ",", "23.729385158182417`"}], 
  "}"}]], "Output",
 CellChangeTimes->{
  3.7278862229627943`*^9, {3.727886559667815*^9, 3.727886599739743*^9}, {
   ...
   3.729183460969283*^9}},ExpressionUUID->"9c58d8c2-2b27-4745-8088-\
fb1d2e0d4ac9"]
}, Open  ]],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.7279153202694693`*^9, 3.727915371067972*^9}, {
  ...
  3.729182515145398*^9}},ExpressionUUID->"0366c8f8-731f-46b1-989e-\
8a3f084dc0e3"],
...
Cell["The normal equations as a symbolic polynomial:", "Text",
 CellChangeTimes->{{3.728086616407036*^9, 3.728086644421227*^9}, {
  ...
  3.728219595133831*^9}},ExpressionUUID->"95b28e3a-41ab-4d74-93c9-\
baf96e1ef0ae"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.7280866505961733`*^9, 3.728086772996965*^9}, 
   ...
   3.7291758460147743`*^9}},ExpressionUUID->"b126ddcf-1a70-41a0-ad49-\
6bc9df477b53"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[CapitalMu]$$ = 3, Typeset`show$$ = True, 
    ...
    True, $CellContext`\[CapitalMu]$4783$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`\[CapitalMu]$$ = 3}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[CapitalMu]$$, $CellContext`\[CapitalMu]$4783$$, 
         0]}, "OtherVariables" :> {
...
$CellContext`\[CapitalMu]$$], 
 ...
 CellChangeTimes->{
  3.728086773562842*^9, 3.728086804275236*^9, 3.728090742426281*^9, 
   ...
   3.7291834481917963`*^9, 
   3.729183461081573*^9}},ExpressionUUID->"a4583c72-4b55-49bb-9722-\
7afcc7f7788a"]
}, Open  ]]
}, Open  ]],
...
Cell["RLS: Recurrent Least Squares", "Subsection",
 CellChangeTimes->{{3.72825197766994*^9, 
  3.72825198556595*^9}},ExpressionUUID->"a29b0553-491f-4543-b4ce-\
4d7ed94ff5f2"],
...
\>", "Text",
 CellChangeTimes->{{3.72792327800198*^9, 3.7279233078789587`*^9}, {
  ...
  3.729182552706852*^9}},ExpressionUUID->"8b9d979c-dca6-4d42-b6f7-\
c8017b2387e8"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727883299044437*^9, 3.727883408526169*^9}, {
   ...
   3.729174255702014*^9}, 
   3.729175632402956*^9},ExpressionUUID->"d7438a05-19df-4e12-8349-\
d389c20a6034"],
...
\[Sigma]2\[CapitalLambda]$4800$$, 0]}, 
 ...
 CellChangeTimes->{{3.727913103888098*^9, 3.7279131297094307`*^9}, 
   ...
   3.729183448249649*^9, 
   3.729183461158495*^9}},ExpressionUUID->"928fdbc4-cacd-436e-a388-\
6cfb13d84cd0"]
}, Open  ]]
}, Open  ]],
...
Cell["KAL: Foldable Kalman Filter", "Subsection",
 CellChangeTimes->{{3.728252019102867*^9, 3.728252024734199*^9}, {
  ...
  3.7290943137983313`*^9}},ExpressionUUID->"e1bb896f-e5d3-4ee9-92ba-\
7bd5482f0ce2"],
...
into its own function slot; ",
 ...
 CellChangeTimes->{{3.727925392992813*^9, 3.727925440455097*^9}, {
  ...
  3.729182599308608*^9}},ExpressionUUID->"961bd538-d11c-4a25-b54d-\
7f8f89289405"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727913455235773*^9, 3.727913522283977*^9}, 
   ...
   3.729174321096059*^9}},ExpressionUUID->"1ea0b5ff-6457-4dd0-b37e-\
08da3a65da61"]
}, Open  ]],
...
Cell["See All Three", "Subsection",
 CellChangeTimes->{{3.729094292024653*^9, 
  3.729094294711062*^9}},ExpressionUUID->"dd15c334-d7db-4d8f-82cd-\
037bf198b9e6"],
...
7cw1IJ39EUKr+rL8uAmk5ZQO/wLRKmKrY+8B6VNaG+NANAD099tH
  ...
  "],ExpressionUUID->"aae3d1b1-67d5-4d6d-b487-9f7d9d186ebd"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727884681931381*^9, 3.7278848244947367`*^9}, 
   ...
   3.729183394521019*^9}},ExpressionUUID->"67a570f0-877b-4814-a9ef-\
3d986bc9d55f"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`kalQ$$ = 
    ...
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`rlsQ$4817$$ = False, $CellContext`kalQ$4818$$ = 
    False, $CellContext`mleQ$4819$$ = 
    False, $CellContext`\[CapitalMu]$4820$$ = 
    0, $CellContext`log\[CapitalLambda]0$4821$$ = 
    0, $CellContext`log\[Sigma]\[Xi]2$4822$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`kalQ$$ = 
        ...
        True, $CellContext`rlsQ$$ = True, $CellContext`\[CapitalMu]$$ = 9}, 
      "ControllerVariables" :> {
        Hold[$CellContext`rlsQ$$, $CellContext`rlsQ$4817$$, False], 
        Hold[$CellContext`kalQ$$, $CellContext`kalQ$4818$$, False], 
        Hold[$CellContext`mleQ$$, $CellContext`mleQ$4819$$, False], 
        Hold[$CellContext`\[CapitalMu]$$, $CellContext`\[CapitalMu]$4820$$, 
         0], 
        Hold[$CellContext`log\[CapitalLambda]0$$, $CellContext`log\
\[CapitalLambda]0$4821$$, 0], 
        Hold[$CellContext`log\[Sigma]\[Xi]2$$, \
$CellContext`log\[Sigma]\[Xi]2$4822$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
...
$CellContext`kalFn$ = Dot[{$CellContext`terms$}, 
 ...
 CellChangeTimes->{
  3.729120694893572*^9, 3.729120729239387*^9, 3.729121073140068*^9, 
   ...
   3.729183461260701*^9}},ExpressionUUID->"f90917f1-45de-4f00-9c0a-\
5a8d59d93b01"]
}, Open  ]]
}, Open  ]]
}, Open  ]],
...
Cell["Renormalizing RLS to KAL", "Subchapter",
 CellChangeTimes->{{3.729092768444851*^9, 3.729092782412208*^9}, {
  3.729191699611701*^9, 
  3.729191706169241*^9}},ExpressionUUID->"f75b9c06-98a2-489d-b244-\
94c348ed37e3"],
...
trusts a-priori estimates more and the solution regularizes."
 ...
 CellChangeTimes->{{3.729093282411186*^9, 3.729093313683037*^9}, {
   ...
   3.7291827056457043`*^9}},ExpressionUUID->"862888f5-52dd-4326-9078-\
b844db04be2f"],
...
\[CapitalLambda]\)]\)) (RLS) \>\""}], "}"}], ",", 
 ...
 CellChangeTimes->{{3.727884681931381*^9, 3.7278848244947367`*^9}, 
   ...
   3.729175642039402*^9}},ExpressionUUID->"8f06fece-73a3-4bad-a09e-\
0290bc87c703"],
...
\[CapitalLambda]\)]\)) (RLS) "}, -3, 8}, {{
    ...
    Typeset`size$$ = {450., {141., 147.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`rlsQ$4849$$ = False, $CellContext`kalQ$4850$$ = 
    False, $CellContext`\[CapitalMu]$4851$$ = 
    0, $CellContext`log\[Sigma]\[Xi]$4852$$ = 
    0, $CellContext`log\[Sigma]\[Zeta]$4853$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`kalQ$$ = 
        True, $CellContext`log\[Sigma]\[Zeta]$$ = 
        ...
        Hold[$CellContext`rlsQ$$, $CellContext`rlsQ$4849$$, False], 
        Hold[$CellContext`kalQ$$, $CellContext`kalQ$4850$$, False], 
        Hold[$CellContext`\[CapitalMu]$$, $CellContext`\[CapitalMu]$4851$$, 
         0], 
        Hold[$CellContext`log\[Sigma]\[Xi]$$, \
$CellContext`log\[Sigma]\[Xi]$4852$$, 0], 
...
\[CapitalLambda]\)]\)) (RLS) "}, -3, 8, Appearance -> "Labeled", 
 ...
 CellChangeTimes->{
  3.7291608432818193`*^9, 3.72916112450849*^9, {3.729161176716465*^9, 
   ...
   3.7291834613216057`*^9}},ExpressionUUID->"ccf0a398-05ba-4499-a526-\
6d08219f4b42"]
}, Open  ]],
...
Cell["Add OBN Noise to RLS", "Subsection",
 CellChangeTimes->{{3.729094358222797*^9, 
  3.7290944123276787`*^9}},ExpressionUUID->"e935529c-6b6d-44f0-8d27-\
31ae86d126c4"],
...
matrix square root of the OBN covariance ",
 ...
 CellChangeTimes->{{3.729094387864348*^9, 3.729094408224104*^9}, {
  ...
  3.729182738415864*^9}},ExpressionUUID->"7a0e8ac9-f039-4b4d-8fdc-\
fa8a2825ab65"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727054852495049*^9, 3.72705494257406*^9}, {
   ...
   3.729174827188703*^9}},ExpressionUUID->"f813888d-5b45-4264-98ee-\
0d0aae79c00e"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.7291748277833652`*^9, 3.7291756918506804`*^9, 3.7291758893603687`*^9, 
   3.729183413149022*^9, {3.72918344848599*^9, 
   3.7291834613900213`*^9}},ExpressionUUID->"6b34174a-9a44-43c6-a16d-\
7f948d254d42"]
}, Open  ]]
}, Open  ]],
...
Cell["Farewell, RLS", "Subsection",
 CellChangeTimes->{{3.729182753746653*^9, 3.729182764662409*^9}, {
  ...
  3.729191746263137*^9}},ExpressionUUID->"c53edecb-4bb4-4598-8c8d-\
85cb50cf3b7d"],
...
\>", "Text",
 CellChangeTimes->{{3.729108318055666*^9, 3.729108347023395*^9}, {
  ...
  3.729191759307276*^9, 
  3.729191781475971*^9}},ExpressionUUID->"43476ea0-931b-4e36-acc3-\
f5aa71cd93a0"]
}, Open  ]]
}, Open  ]]
}, Open  ]],
...
Cell["Regularization and MAP", "Chapter",
 ...
 CellTags->"c:14",ExpressionUUID->"9c314e96-b47b-46d6-aeb6-c31b7ea7ec2a"],
...
\[CloseCurlyQuote]s matrix ",
 ...
 CellChangeTimes->{{3.727971621209344*^9, 3.727971949635846*^9}, {
  ...
  3.729194830792169*^9}},ExpressionUUID->"35b3987d-c64b-4b74-8ffa-\
d150dc2a8aef"],
...
Cell["Bishop\[CloseCurlyQuote]s MAP", "Subchapter",
 ...
 CellTags->"c:15",ExpressionUUID->"db895d6d-bf21-4c1f-9090-f53b5161c62c"],
...
The dimensions of the identity matrix in ",
 ...
 CellChangeTimes->{{3.727972249677867*^9, 3.727972263698797*^9}, {
   ...
   3.7291828738856*^9}},ExpressionUUID->"88965f33-c043-46de-8400-\
9f56cf31493e"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727972280222818*^9, 3.7279724431858997`*^9}, {
  ...
  3.7279731267447147`*^9}},ExpressionUUID->"a3d03326-8807-480c-8bc7-\
6edc38a29e74"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.7279724613260727`*^9, 3.727972528960863*^9}, {
  ...
  3.727973133972931*^9}},ExpressionUUID->"4ec05f2c-60ee-4854-9f2c-\
6141b503e2af"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.72797275156035*^9, 3.727972881609983*^9}, {
  ...
  3.727992388437778*^9}},ExpressionUUID->"d589c541-9fa6-4edf-bc85-\
d784d1699dbf"],
...
\>", "Text",
 CellChangeTimes->{{3.728247291344137*^9, 3.728247310423942*^9}, {
  3.728248735711397*^9, 
  3.7282487376877623`*^9}},ExpressionUUID->"a2fca28f-6b9a-45ed-b200-\
0359e919a5b2"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.728246767415718*^9, 3.728246838582246*^9}, {
  ...
  3.72824728616096*^9}},ExpressionUUID->"955baf45-ea22-496f-8a6f-\
b4e74416463d"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.728247724107789*^9, 
  3.728247835449356*^9}},ExpressionUUID->"bb43143c-19f1-483d-bc32-\
581a721cbcef"],
...
Cell["\[CapitalPhi] Vectors", "Subsection",
 CellChangeTimes->{{3.728246200325514*^9, 
  3.72824620633247*^9}},ExpressionUUID->"fc9d51ae-0521-4e75-983e-\
ae89c5323aad"],
...
requiring all data ",
 ...
 CellChangeTimes->{{3.727972933675117*^9, 3.727973078876171*^9}, {
   ...
   3.7291828972165833`*^9},ExpressionUUID->"0d71bd93-8e0f-4bf7-ba8e-\
ac1e73f05efd"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727973167925046*^9, 3.7279732069191923`*^9}, {
   ...
   3.729175642856516*^9},ExpressionUUID->"3e8983e1-6f2e-4bc7-9e09-\
413fedd42524"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.72797476735454*^9, {3.727989442724881*^9, 3.7279894588380623`*^9}, {
   ...
   3.729183461458799*^9}},ExpressionUUID->"d0c5e874-cfba-408e-a30b-\
98ac8752c805"]
}, Open  ]]
}, Open  ]],
...
Cell["S Inverse", "Subsection",
 CellChangeTimes->{{3.7282461813905153`*^9, 
  3.728246183677311*^9}},ExpressionUUID->"5c9f31ee-9eea-49ac-94cf-\
200029caceff"],
...
Cell["Bishop\[CloseCurlyQuote]s equation 1.72.", "Text",
 CellChangeTimes->{{3.727973854544991*^9, 3.727973958387879*^9}, {
  ...
  3.729173508646914*^9, 
  3.7291735382601423`*^9}},ExpressionUUID->"7dec4bd6-f7c2-4ae0-95ec-\
b15924b8e573"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727973884729273*^9, 3.727973893707472*^9}, {
   ...
   3.729173515353211*^9}},ExpressionUUID->"f7ad225e-0471-4726-ac3b-\
efd5ce778b5f"]
}, Open  ]],
...
Cell["MAP Mean", "Subsection",
 CellChangeTimes->{{3.7282462270238667`*^9, 
  3.7282462292069902`*^9}},ExpressionUUID->"0571afbb-5fb4-4073-9ca9-\
91bbf7630ad6"],
...
Cell["Bishop\[CloseCurlyQuote]s equation 1.70.", "Text",
 CellChangeTimes->{{3.7279935722104673`*^9, 3.727993577636578*^9}, {
   ...
   3.72917177432257*^9}, 
   3.729182916782524*^9},ExpressionUUID->"deb8bd22-943b-491b-9a86-\
be630f05e17c"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727989096190207*^9, 3.727989111607684*^9}, {
   ...
   3.729179191813648*^9}},ExpressionUUID->"7f9b51a9-c206-417e-8600-\
3dfd0aa40d22"],
...
\[CloseCurlyQuote]s ",
 Cell[BoxData[
  ...
  ExpressionUUID->"68d2d352-6973-41f9-89cc-9dcf59424cf0"],
 " (observation noise) and Bishop\[CloseCurlyQuote]s \[Beta] is Kalman\
\[CloseCurlyQuote]s ",
 Cell[BoxData[
  FormBox[
   SubsuperscriptBox["\[Sigma]", "\[Xi]", "2"], TraditionalForm]],
  ExpressionUUID->"91e4cdbd-1421-4c36-b219-b8b8e13215f8"],
 " (a-priori covariance). As ",
 Cell[BoxData[
  FormBox[
   SubsuperscriptBox["\[Sigma]", "\[Zeta]", "2"], TraditionalForm]],
  ExpressionUUID->"5e5db25b-b378-4176-9e2a-6ea3aab628f7"],
 " ",
 StyleBox["decreases",
  FontSlant->"Italic"],
...
As ",
 Cell[BoxData[
  FormBox[
   SubsuperscriptBox["\[Sigma]", "\[Xi]", "2"], TraditionalForm]],
  ExpressionUUID->"494120cf-3493-421b-b790-0d38da9d888d"],
 " ",
 StyleBox["decreases",
  FontSlant->"Italic"],
...
phenomena."
 ...
 CellChangeTimes->{{3.729179074561894*^9, 3.7291791396109753`*^9}, {
  ...
  3.72919585877461*^9, 
  3.729195894789111*^9}},ExpressionUUID->"e74f6ee8-075b-4ffa-83bc-\
f2adb4d76d3e"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727884681931381*^9, 3.7278848244947367`*^9}, 
   ...
   3.729195946539386*^9, 
   3.729195963662328*^9}},ExpressionUUID->"4fc9cdbe-0c93-4ce9-b21d-\
79cd2ba70e84"],
...
$CellContext`log = Log10[0.005]; $CellContext`\[Beta] = 1/0.09)& ], 
    ...
    Typeset`size$$ = {450., {141., 147.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`kalQ$88174$$ = False, $CellContext`mleQ$88175$$ = 
    False, $CellContext`mapQ$88176$$ = 
    False, $CellContext`\[CapitalMu]$88177$$ = 
    0, $CellContext`log\[Sigma]\[Xi]$88178$$ = 
    0, $CellContext`log\[Sigma]\[Zeta]$88179$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`kalQ$$ = 
...
\[Sigma]\[Xi]$$ = 0.5, $CellContext`mapQ$$ = True, $CellContext`mleQ$$ = 
        ...
        Hold[$CellContext`kalQ$$, $CellContext`kalQ$88174$$, False], 
        Hold[$CellContext`mleQ$$, $CellContext`mleQ$88175$$, False], 
        Hold[$CellContext`mapQ$$, $CellContext`mapQ$88176$$, False], 
        Hold[$CellContext`\[CapitalMu]$$, $CellContext`\[CapitalMu]$88177$$, 
         0], 
        Hold[$CellContext`log\[Sigma]\[Xi]$$, \
$CellContext`log\[Sigma]\[Xi]$88178$$, 0], 
        Hold[$CellContext`log\[Sigma]\[Zeta]$$, $CellContext`log\[Sigma]\
\[Zeta]$88179$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
...
$CellContext`log = Log10[0.005]; $CellContext`\[Beta] = 1/0.09)& ], 
 ...
 CellChangeTimes->{{3.72917900077596*^9, 3.729179019701797*^9}, {
   ...
   3.729190514562058*^9, 
   3.729195964726397*^9},ExpressionUUID->"b07ee6ac-711a-4bdf-a99d-\
54e8ab0ad320"]
}, Open  ]]
}, Open  ]],
...
Cell["Covariance of the Estimate", "Subsection",
 CellChangeTimes->{{3.729182953019375*^9, 
  3.7291829585476*^9}},ExpressionUUID->"f95b9701-23f3-4bae-b37a-d7fca9c1cb44"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.727994165301249*^9, 3.7279941851829967`*^9}, {
  ...
  3.729190329452014*^9}},ExpressionUUID->"45eba111-be02-451e-ba41-\
e1fc86602c9e"],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.727994197366062*^9, 3.7279942096588373`*^9}, {
   ...
   3.729195696029108*^9, 
   3.729195744219352*^9}},ExpressionUUID->"c07ae07f-8258-4446-90e8-\
33ff1def0e9b"],
...
those, we follow Bishop\[CloseCurlyQuote]s analysis and his equation 1.71."
 ...
 CellChangeTimes->{{3.728047983582913*^9, 3.728048001419952*^9}, {
   ...
   3.7291963938344088`*^9}},ExpressionUUID->"945071bc-3697-45ea-8676-\
352d9e2d959d"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.727884681931381*^9, 3.7278848244947367`*^9}, 
   ...
   3.729196403932249*^9, 
   3.729196414116873*^9}},ExpressionUUID->"19f9bb59-266e-43fb-9950-\
8b579ef1e79e"],
...
$CellContext`log\[Sigma]\[Xi]$$ = 0.5228787452803376, $CellContext`mapQ$$ = 
    ...
    Typeset`size$$ = {450., {141., 147.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`kalQ$102198$$ = False, $CellContext`mleQ$102199$$ = 
    False, $CellContext`mapQ$102200$$ = 
    False, $CellContext`\[CapitalMu]$102201$$ = 
    0, $CellContext`log\[Sigma]\[Xi]$102202$$ = 
    0, $CellContext`log\[Sigma]\[Zeta]$102203$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`kalQ$$ = 
        True, $CellContext`log\[Sigma]\[Zeta]$$ = -1.1505149978319906`, \
$CellContext`log\[Sigma]\[Xi]$$ = 0.5228787452803376, $CellContext`mapQ$$ = 
        True, $CellContext`mleQ$$ = False, $CellContext`\[CapitalMu]$$ = 9}, 
      "ControllerVariables" :> {
        Hold[$CellContext`kalQ$$, $CellContext`kalQ$102198$$, False], 
        Hold[$CellContext`mleQ$$, $CellContext`mleQ$102199$$, False], 
        Hold[$CellContext`mapQ$$, $CellContext`mapQ$102200$$, False], 
        Hold[$CellContext`\[CapitalMu]$$, $CellContext`\[CapitalMu]$102201$$, 
         0], 
        Hold[$CellContext`log\[Sigma]\[Xi]$$, \
$CellContext`log\[Sigma]\[Xi]$102202$$, 0], 
        Hold[$CellContext`log\[Sigma]\[Zeta]$$, $CellContext`log\[Sigma]\
\[Zeta]$102203$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
...
$CellContext`cs$, $CellContext`ts$, $CellContext`\[CapitalMu]$$]]}, 
 ...
 CellChangeTimes->{
  3.729192135929804*^9, 3.7291922278453083`*^9, {3.729193547075082*^9, 
   ...
   3.729196352157159*^9, 3.7291963729616833`*^9}, 
   3.729196414663275*^9},ExpressionUUID->"768a06b0-d334-4284-bf45-\
d1b3a7cb7e5d"]
}, Open  ]]
}, Open  ]]
}, Open  ]]
...
Cell["Conclusion", "Chapter",
 CellChangeTimes->{{3.729196441150124*^9, 
  3.7291964428392887`*^9}},ExpressionUUID->"f167666f-43dc-42f6-a9ec-\
b14391dc7386"],
...
choices of covariances and regularization hyperparameters. KAL and RLS offer \
...
\>", "Text",
 CellChangeTimes->{{3.7291964484304113`*^9, 3.729196613945616*^9}, 
   3.7292030970835457`*^9},ExpressionUUID->"4698e9d2-1ed7-411b-ab39-\
7be519e88e23"]
}, Open  ]]
}, Open  ]]
},
...
CellTagsIndex->{
 "c:1"->{
  Cell[1510, 35, 472, 7, 190, "Title",ExpressionUUID->"0540a1cc-e020-48c4-ad3a-1cf7bdc9c94f",
   CellTags->"c:1"]},
 "c:10"->{
  Cell[136335, 2891, 256, 3, 125, "Subchapter",
   CellTags->"c:10"]},
 "c:11"->{
  Cell[146366, 3144, 299, 4, 70, "Chapter",ExpressionUUID->"d25f42d7-e348-4b08-8aea-075972d5ca64",
   CellTags->"c:11"]},
 "c:12"->{
  Cell[164080, 3557, 195, 2, 125, "Subchapter",
   CellTags->"c:12"]},
 "c:13"->{
  Cell[171677, 3739, 450, 6, 70, "Chapter",ExpressionUUID->"d3041eb5-92b7-404a-850f-04a66112104e",
   CellTags->"c:13"]},
 "c:14"->{
  Cell[308301, 6845, 181, 2, 85, "Chapter",ExpressionUUID->"9c314e96-b47b-46d6-aeb6-c31b7ea7ec2a",
   CellTags->"c:14"]},
 "c:15"->{
  Cell[310198, 6896, 241, 3, 80, "Subchapter",ExpressionUUID->"db895d6d-bf21-4c1f-9090-f53b5161c62c",
   CellTags->"c:15"]},
 "c:2"->{
  Cell[2283, 55, 219, 3, 85, "Chapter",ExpressionUUID->"5e0180b3-3c40-44e9-aba7-410fedc57026",
   CellTags->"c:2"]},
 "c:3"->{
  Cell[6625, 134, 178, 2, 85, "Chapter",ExpressionUUID->"31945649-f442-4196-bb95-0d6fdda58a65",
   CellTags->"c:3"]},
 "c:4"->{
  Cell[13185, 312, 297, 4, 80, "Subchapter",ExpressionUUID->"636be563-b890-4fa7-a152-6abfb292754a",
   CellTags->"c:4"]},
 "c:5"->{
  Cell[15581, 375, 197, 3, 80, "Subchapter",ExpressionUUID->"9f842923-9949-44ca-8d1b-b3fb047c2360",
   CellTags->"c:5"]},
 "c:6"->{
  Cell[22151, 522, 268, 3, 80, "Subchapter",ExpressionUUID->"ed4b3f42-28ab-4def-aed5-10e1235e487b",
   CellTags->"c:6"]},
 "c:7"->{
  Cell[27790, 637, 228, 3, 80, "Subchapter",ExpressionUUID->"359c8b98-b373-469b-934f-29e1f786de4f",
   CellTags->"c:7"]},
 "c:8"->{
  Cell[72512, 1445, 325, 4, 80, "Subchapter",ExpressionUUID->"b269de7a-be26-4922-acaf-81a723a49d7c",
   CellTags->"c:8"]},
 "c:9"->{
  Cell[84681, 1738, 218, 3, 85, "Chapter",ExpressionUUID->"d1275f2e-a3da-4b1f-98da-bf8c7b69abe3",
   CellTags->"c:9"]}
 }
*)
(*CellTagsIndex
...
Cell[1510, 35, 472, 7, 190, "Title",ExpressionUUID->"0540a1cc-e020-48c4-ad3a-1cf7bdc9c94f",
 CellTags->"c:1"],
Cell[1985, 44, 273, 7, 86, "Text",ExpressionUUID->"3a7a16f2-5eb2-415e-97fc-df9157cf69b2"],
Cell[CellGroupData[{
Cell[2283, 55, 219, 3, 85, "Chapter",ExpressionUUID->"5e0180b3-3c40-44e9-aba7-410fedc57026",
 CellTags->"c:2"],
